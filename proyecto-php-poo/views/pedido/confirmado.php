<?php if (isset($_SESSION['pedido']) && $_SESSION['pedido'] == 'completed') : ?>
    ...
    <p>Tu pedido ha sido guardado con éxito. Una vez que realices la transferencia bancaria 854846478746844964 con el coste del pedido, será procesado y enviado.</p>
    <br>
    <?php if (isset($pedido)) : ?>
